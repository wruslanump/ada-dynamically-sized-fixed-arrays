...
-- ========================================================
package body pkg_ada_dynsized_fized2d_arrays
-- ========================================================
   with SPARK_Mode => on 
...
is
   ...
   -- =====================================================
  -- function get_2d_integer_array () return typ_2d_integer_array  is  
   
   
   -- end get_2d_integer_array;   
   -- ===================================================== 
...
begin
    null;
-- ========================================================
end pkg_ada_dynsized_fized2d_arrays;
-- ========================================================
