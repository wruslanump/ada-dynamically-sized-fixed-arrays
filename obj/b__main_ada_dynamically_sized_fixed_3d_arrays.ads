...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_dynamically_sized_fixed_3d_arrays" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c38995af#;
   pragma Export (C, u00001, "main_ada_dynamically_sized_fixed_3d_arraysB");
   ...
   u00226 : constant Version_32 := 16#b45fa9ee#;
   pragma Export (C, u00226, "pkg_ada_dynsized_fixed3d_arraysB");
   u00227 : constant Version_32 := 16#ae37a744#;
   pragma Export (C, u00227, "pkg_ada_dynsized_fixed3d_arraysS");
   ...
   u00237 : constant Version_32 := 16#2323a8af#;
   pragma Export (C, u00237, "system__memoryB");
   u00238 : constant Version_32 := 16#1f488a30#;
   ...
   --  pkg_ada_dynsized_fixed3d_arrays%s
   --  pkg_ada_dynsized_fixed3d_arrays%b
   --  pkg_ada_random_numbers%s
   --  pkg_ada_random_numbers%b
   --  main_ada_dynamically_sized_fixed_3d_arrays%b
