...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_dynamically_sized_fixed_1d_arrays" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4a2da337#;
   pragma Export (C, u00001, "main_ada_dynamically_sized_fixed_1d_arraysB");
   ...
   u00226 : constant Version_32 := 16#55ae2c2c#;
   pragma Export (C, u00226, "pkg_ada_dynsized_fixed1d_arraysB");
   u00227 : constant Version_32 := 16#cc1166f7#;
   pragma Export (C, u00227, "pkg_ada_dynsized_fixed1d_arraysS");
   u00228 : constant Version_32 := 16#58fa4b18#;
   pragma Export (C, u00228, "pkg_ada_dynsized_fixed2d_arraysB");
   u00229 : constant Version_32 := 16#dd149ad5#;
   pragma Export (C, u00229, "pkg_ada_dynsized_fixed2d_arraysS");
   u00230 : constant Version_32 := 16#618863ac#;
   pragma Export (C, u00230, "pkg_ada_random_numbersB");
   u00231 : constant Version_32 := 16#60ba9a03#;
   pragma Export (C, u00231, "pkg_ada_random_numbersS");
   u00232 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00232, "ada__numericsS");
   u00233 : constant Version_32 := 16#d976e2b4#;
   pragma Export (C, u00233, "ada__numerics__float_randomB");
   u00234 : constant Version_32 := 16#62aa8dd2#;
   pragma Export (C, u00234, "ada__numerics__float_randomS");
   u00235 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00235, "system__random_numbersB");
   u00236 : constant Version_32 := 16#852d5c9e#;
   pragma Export (C, u00236, "system__random_numbersS");
   u00237 : constant Version_32 := 16#e0ac52ca#;
   pragma Export (C, u00237, "system__random_seedB");
   u00238 : constant Version_32 := 16#1d25c55f#;
   pragma Export (C, u00238, "system__random_seedS");
   u00239 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00239, "system__concat_4B");
   u00240 : constant Version_32 := 16#3851c724#;
   pragma Export (C, u00240, "system__concat_4S");
   u00241 : constant Version_32 := 16#2b93a046#;
   pragma Export (C, u00241, "system__img_charB");
   u00242 : constant Version_32 := 16#da01b4e3#;
   pragma Export (C, u00242, "system__img_charS");
